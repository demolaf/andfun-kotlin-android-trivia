...
class GameWonFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        // Fetching the args and expanding to onCreateView within
        // GameWonFragment
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        ...
        // check if the activity resolves, this will make sure not to show
        // the share button if no app is able to carryout the task
        if(null == getShareIntent().resolveActivity(requireActivity()
                        .packageManager)) {
